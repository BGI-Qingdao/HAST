...
open OUT,"| gzip > SampleName_S1_L001_R1_001.fastq.gz" or die "failed to open SampleName_S1_L001_R1_001.fastq.gz for write";
open OUT3,"| gzip >SampleName_S1_L001_R2_001.fastq.gz" or die "failed to open SampleName_S1_L001_R2_001.fastq.gz for write";
