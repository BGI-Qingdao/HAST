...
plt.axvline(x=maternal_max,ls='--',c='r',label="MAX INDEX %d "%maternal_max)
plt.axvline(x=maternal_lower,ls='-.',c='g',label="LOWER INDEX %d "%maternal_lower)
...
plt.axvline(x=paternal_max,ls='--',c='r',label="MAX INDEX %d "%paternal_max)
plt.axvline(x=paternal_lower,ls='-.',c='g',label="LOWER INDEX %d "%paternal_lower)
