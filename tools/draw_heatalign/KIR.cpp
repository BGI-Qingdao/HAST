...
const int scale_len = 1100000;
const int scale_step = 50000;
const int scale_lable_step=100000;
const std::string scale_label("00Kb");
const float min_idy = 0.89;
const std::string ref_name("GRCH38 KIR");
/*******************************************************************************
 *
